...
module.exports = {
  ...
  apps: {
    'android.debug': {
      type: 'android.apk',
      binaryPath: 'cd android && ./gradlew assembleDebug assembleAndroidTest -DtestBuildType=debug',
      build: 'android/app/build/outputs/apk/debug/app-debug.apk',
      testBinaryPath: 'custom/path/to/app-debug-androidTest.apk'
    },
    'android.release': {
      type: 'android.apk',
      binaryPath: 'cd android && ./gradlew assembleRelease assembleAndroidTest -DtestBuildType=release',
