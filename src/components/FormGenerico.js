...
export default function FormGenerico({ title, fields = [], buttonText, onSubmit, GoogleButton = false, linkText, NãoTem }) {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* ButtonGoogle */}
            {GoogleButton && (
                <TouchableOpacity style={{ backgroundColor: '#E9F1FF', width: '100%', height: 50, borderRadius: 10, justifyContent: 'center', alignItems: 'center', flexDirection: 'row', gap: 10 }}>
